...
public class MSCAggregate extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mscaggregate);
        ...
        bech_marks = (EditText) findViewById(R.id.et_bech);
        total_bech_marks = (EditText) findViewById(R.id.et_total_bech_marks);
    ...
    public void calculateBS(View v)
    {
        ...
        float inter = (inter_marks.getText().toString().equals("")) ? 0 : Float.parseFloat(inter_marks.getText().toString())/5;
        float tmetric = (total_matric_marks.getText().toString().equals("")) ? 0 : Float.parseFloat(total_matric_marks.getText().toString())/4;
        float tinter = (total_inter_marks.getText().toString().equals("")) ? 0 : Float.parseFloat(total_inter_marks.getText().toString())/5;
        float testm = (entry_test_marks.getText().toString().equals("")) ? 0 : Float.parseFloat(entry_test_marks.getText().toString());
        float bech = (bech_marks.getText().toString().equals("")) ? 0 : Float.parseFloat(bech_marks.getText().toString());
        float tbech = (total_bech_marks.getText().toString().equals("")) ? 0 : Float.parseFloat(total_bech_marks.getText().toString());
        float ttestm = 40;
        ...
        float A = (metric + inter + bech + nhQ) / (tmetric + tinter + tbech) * 70;
